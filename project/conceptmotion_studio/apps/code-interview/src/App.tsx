...
export default function App() {
  ...
  return <AppShell mainLabel="Code Interview" topBar={<TopBar brand="Code Interview" subtitle="Think clearly. Explain your trade-offs." localeControl={<LanguageToggle />} navigation={<><Button onClick={() => { setMode(null); setShowProgress(false); }}>Sessions</Button><Button onClick={() => { setMode(null); setShowProgress(true); }}>Progress</Button></>} />}>
