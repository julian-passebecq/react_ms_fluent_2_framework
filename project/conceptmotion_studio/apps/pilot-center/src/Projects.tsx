...
import { projectGalaxyFigure } from './projectDiagram';
...
export function Projects({ projects, overlays, onOverlay }: { projects: ProjectRegistry; overlays: LocalProjectMetadata[]; onOverlay: (overlay: LocalProjectMetadata) => boolean }) {
  ...
  const figure = useMemo(() => projectGalaxyFigure(projects), [projects]);
  return <section className="pilot-stack" data-testid="pilot-projects">
