...
export default function App() {
  ...
  return <div className="atlas-app"><a href="#main" className="atlas-skip">Skip to content</a><header className="atlas-top"><a className="atlas-brand" href="#">Algorithm Atlas</a><span>Patterns, explained.</span><LanguageToggle /></header><main id="main" className="atlas-main">
    {entry ? <Suspense fallback={<p role="status">Loading semantic scene…</p>}><SceneDetail entry={entry} locale={locale} /></Suspense> : <>
