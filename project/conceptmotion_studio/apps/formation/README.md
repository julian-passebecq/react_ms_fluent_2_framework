...
Formation evolves the Foundation V2 reference learning consumer. It proves that a focused course site can be assembled from shared Datapass contracts and Fluent surfaces without copying framework code into the application.
...
## V3 reasoning capstones

The Python and SQL Advanced courses end with **Think in Python for Data Engineering** and **Think in SQL**. These modules reuse the Algorithm Atlas Figure catalog, production FigurePlayer controls, prediction assessments and existing local progress. Old lesson and progress IDs remain unchanged.
