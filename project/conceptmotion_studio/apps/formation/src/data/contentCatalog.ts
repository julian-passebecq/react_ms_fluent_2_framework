...
export const sqlFilterFigure: FigureSpec = {
  ...
  subtitle: 'WHERE keeps only the products that match',
  takeaway: 'Products 101 and 104 retain their original values after filtering.',
  spec: toCanonicalJsonValue({
    kind: 'table',
    version: '2',
    id: 'scene.dubreu.sql-filter',
    title: 'Products before and after WHERE',
    description: 'Compare the products before and after filtering.',
...
export const sqlNotebook: NotebookSpec = {
  ...
  cells: [
      ...
      : cell),
    {
      ...
      type: 'markdown',
      markdown: '## See what the predicate changes\nFollow the same products before and after the filter.',
...
export const runtimeTargets: readonly RuntimeTarget[] = [
  {
    ...
    description: 'Download the original Python example to practice in your own environment.',
  ...
  },
  {
    ...
    kind: 'download',
    label: 'SQL notebook',
    description: 'Download the original notebook used in this lesson.',
  ...
  },
  {
    ...
    description: 'Download the original SQL example to compare with your query.',
  ...
  },
  {
    ...
    kind: 'colab',
    label: 'Colab',
    description: 'Open Google Colab, then upload and run the example there.',
  ...
  },
  {
    ...
    modules: [{
      ...
      lessons: [{
        ...
        summary: 'Keep the rows that satisfy two conditions, with their original values.',
