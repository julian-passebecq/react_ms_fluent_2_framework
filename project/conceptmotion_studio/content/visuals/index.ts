...
export const migratedVisuals: readonly VisualMigration[] = [...sqlVisuals, ...algorithmVisuals, ...systemsVisuals].map(refineVisual);
export const migratedFigures: readonly FigureSpec[] = migratedVisuals.map(entry => entry.figure);
