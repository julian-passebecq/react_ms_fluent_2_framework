...
Class D deferrals include logistic probability/boundary geometry, random forests, gradient boosting, k-NN, SVM, k-means iteration geometry, PCA projections, neural-network geometry, and the remaining historical 28 legacy renderer families. They need no placeholder new renderer in V3. No D3 SDK/Power BI rewrite, GeoStory, model training, Spark/Jupyter runtime, backend or external monitoring was added.
